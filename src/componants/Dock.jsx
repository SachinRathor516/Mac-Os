...
const Dock = ({ windowsState, setWindowsState }) => {
  return (
    <footer className='dock'>
      ...
      <div
       onClick={()=>{window.open("https://www.linkedin.com/in/sachin-rathor-a329a8354/?skipRedirect=true", "_blank")}}
       className="icon link"><img src="/doc-icons/link.svg" alt="" /></div>
     
      <div 
      onClick={()=>{window.open("mailto:sachinrathor516@gmail.com", "_blank")}}
